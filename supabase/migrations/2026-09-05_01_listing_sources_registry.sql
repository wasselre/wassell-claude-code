-- ============================================================================
-- Phase 1 · Gate A · 01 · listing_sources registry
...
-- Gate C/D migration) rejects any source that is not present, active, and
-- enabled here, so a new platform is onboarded by INSERTing a row + shipping
-- its adapter — never by editing publisher SQL.
--
...
-- actionable error here, never a raw undefined-function error mid-migration.
DO $preflight$
BEGIN
