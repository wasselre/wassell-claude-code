-- ============================================================================
-- Rollback for Phase 3 · B2A.1 — set-based grant and folder resolution
--
-- Restores the B2A files_select policy verbatim (the row-function form) and
-- drops the three set helpers. B2A itself stays installed and untouched, so
-- rolling back lands on the verified, already-live B2A behaviour rather than
-- all the way back to the slow original.
--
-- Reach is unchanged in either direction, so this is safe at any time.
-- ============================================================================
