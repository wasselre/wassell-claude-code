...
**Status:** Live
**Last updated:** 2026-06-03 (extraction redesign — model-aware + numeric + deep floor-plan analysis; counting moved INTO extraction; a post-extraction summary + chat replaces the step-2 counter and the one-shot "Ask AI")
