...
**Status:** Live
**Last updated:** 2026-04-20 (branching workflows: one trigger can now fan out into if / else-if / else arms, each with its own conditions + actions, rendered as a top-down tree in the editor)
