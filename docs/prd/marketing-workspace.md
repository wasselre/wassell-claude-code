...
| `src/pages/Marketing/CampaignsPage.tsx` / `CampaignDetailPage.tsx` | Spend: campaigns, executions, results. Both forms carry the required goal multi-select; the list gained a Goal filter; the detail brief shows linked goals as chips |
