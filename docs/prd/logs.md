...
| `api/agent.ts` | **DELETED 2026-07-22** (commit `203f410` — AI agent archived) — was: logs one row per Claude turn with full `tool_calls` array. Historic rows remain readable on `/logs`. |
