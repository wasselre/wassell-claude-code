TASK: The mobile layer — MobileTabBar + the ten mobile screens, matching design screens 28–32, 46, 48, 49, 51, 52 EXACTLY. Files: NEW src/pages/Marketing/components/MobileTabBar.tsx, NEW src/pages/Marketing/AccountPage.tsx (/m/account + route in App.tsx /m tree), targeted responsive additions to existing pages, and a NEW file src/pages/Marketing/styles/mobile.css (import from MobileTabBar.tsx; .mos-root-scoped; do NOT touch mos.css) (media queries <760px; use the mockup phone CSS as the source — the .ph-* styles in the source screens translate to the app's mobile classes).
