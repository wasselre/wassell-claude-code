// WORKER COPY of src/lib/projects/unitView.ts — the PURE resolver for `units`
// records. Straight port with the `@/types` import repointed at the worker's
// projectTypes shim; all other imports come from the ported projectView.js.
// Keep semantically identical to the canonical resolver.

import type { AppRecord } from './projectTypes.js';
import {
