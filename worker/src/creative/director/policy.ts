 ...
 * recommendations. PURE module (no I/O): A-API mirrors it in
 * `src/lib/creative/policy.ts` so the API can refuse a queued execution with
 * the same verdict the worker gave.
 *
...
import type { AiMode, AiRecommendation } from '../contracts.js';
