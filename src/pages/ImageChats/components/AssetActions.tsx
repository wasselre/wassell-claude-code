 ...
 * both the right-rail SelectedAssetPanel and the full-screen AssetLightbox so
 * the two surfaces never drift. Hosts the v2 Add-to-Files / Add-to-Record
 * modals internally (a lightweight image shape — no message-cache for v3
 * assets). Download / Copy URL act on the output's public URL directly.
 */
export default function AssetActions({ output, onCreateVariation, onUseAsReference, onRegenerate }: Props) {
